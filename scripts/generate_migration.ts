/**
 * 临时脚本：从 seed.ts 的数据生成 001 迁移 SQL 文件
 * 运行: npx tsx scripts/generate_migration.ts
 */
...
async function main() {
  ...
  const pages: [string, string, string, string, string, string, number][] = [
    ...
    [
      "culture", "about", "企业文化", "Corporate Culture",
    ...
    [
      "subsidiaries", "business", "子公司关系", "Subsidiary Relationships",
    ...
    [
      "products", "business", "核心产品体系", "Core Product System",
    ...
    [
      "electronics", "business", "高精密电子组件业务", "Precision Electronic Components",
    ...
    [
      "lab", "business", "重点实验室科研成果", "Key Lab Research Achievements",
    ...
    [
      "global", "business", "全球产业布局", "Global Industry Layout",
    ...
    [
      "governance", "about", "企业管治", "Corporate Governance",
    ...
    [
      "business", "business", "产业与业务", "Business",
    ...
    [
      "links", "other", "航天联结", "Aerospace Links",
  ...
  // 生成 INSERT 语句的 SQL 文件
  // sql.js 没有直接的 dump 功能，我们手动构建 SQL
