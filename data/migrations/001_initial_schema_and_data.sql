-- ============================================================
-- Migration 001: 初始建表 + 种子数据
-- 这是首次部署时执行的迁移，包含全部表和初始数据
-- ============================================================
...
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('about', 'about', '关于我们', 'About Us', '中国航天国际控股有限公司（航天控股）是中国航天科技集团公司（中国航天）在香港的上市公司（股份代号：31）。作为中国航天的海外窗口和国际化平台，航天控股承载着连接中国航天与全球市场的桥梁使命。

本栏目汇集了公司背景、企业文化、发展目标、董事局成员及企业管治等核心信息，帮助您全面了解航天控股的发展历程与治理架构。', 'China Aerospace International Holdings Limited (CASIL) is a Hong Kong-listed company (Stock Code: 31) of China Aerospace Science and Technology Corporation (CASC). As the overseas window and international platform of CASC, CASIL serves as a bridge connecting China''s aerospace industry with the global market.
...
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('culture', 'about', '企业文化', 'Corporate Culture', '「爱国、创新、诚信、和谐、尽责」为本公司企业文化的核心，亦为本公司企业使命和业务发展原则，也是员工作为日常业务运作和作业方向的核心价值：
...
企业文化与发展策略
本公司制定了长远的规划纲要，并持续评估本公司面对的潜在机遇与挑战。通过本公司企业文化的核心: 「爱国、创新、诚信、和谐、尽责」，持续提升本公司员工的道德操守、完善公司管治制度、防范公司合规经营风险，为员工本身及公司建立竞争优势，让公司各项业务稳定发展。', '"Patriotism, Innovation, Integrity, Harmony, Responsibility" are the core values of our corporate culture, the mission and business development principles of the Company, and the core values that guide employees in their daily operations:
...
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('goals', 'about', '目标', 'Goals', '航天控股将在大股东中国航天的鼎力支持下，充分利用香港各方面的优势，逐步实现建设成为一个具有科学化的管理体系、强势的整体市场竞争能力、优质的战略合作伙伴，为股东创造良好的投资价值。
...
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('subsidiaries', 'business', '子公司关系', 'Subsidiary Relationships', '全资子公司
康源电子厂：PCB、IC封装载板业务
康惠惠州半导体：显示模组、传感器封装
志源实业：储能电池相关业务
志源塑胶制品：精密结构件制造
...
参股企业
瑞华泰薄膜：新材料领域布局', 'Wholly-owned Subsidiaries
...
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('products', 'business', '核心产品体系', 'Core Product System', '中国航天国际控股背靠航天科技集团，拥有扎实的核心科技竞争实力。公司掌握高端 IC 封装载板、车规级功率模块、精密 PCB 电路板等关键制造技术，工艺水准跻身国内前列，有效填补本土产业缺口。依托成熟精密加工体系，产品广泛适配 AI 算力设备、新能源汽车、低空无人机及智能机器人等高景气领域。同时企业具备完善研发创新能力，手握多项技术专利，积淀深厚技术壁垒，叠加优质头部客户资源加持，形成技术研发、生产制造、市场供货一体化优势，在国产替代进程中持续强化自身行业竞争力。', 'CASIL, backed by CASC, possesses solid core technological competitiveness. The company masters key manufacturing technologies including high-end IC packaging substrates, automotive-grade power modules, and precision PCB circuit boards, with process standards ranking among the top in China. Leveraging a mature precision manufacturing system, products are widely applied in AI computing equipment, new energy vehicles, low-altitude drones, and intelligent robots. The company has comprehensive R&D innovation capabilities, holding multiple technology patents with deep technical barriers, forming an integrated advantage of technology R&D, manufacturing, and market supply.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('electronics', 'business', '高精密电子组件业务', 'Precision Electronic Components', '高精密电子组件业务内容涵盖IC封装载板、高密度互连板(HDI)、柔性电路板(FPC)及刚挠结合板等高端PCB产品的研发、制造与销售。产品广泛应用于5G通信设备、AI服务器、自动驾驶系统、医疗电子设备及航空航天等领域。', 'The precision electronic components business covers the R&D, manufacturing and sales of high-end PCB products including IC packaging substrates, high-density interconnect (HDI) boards, flexible printed circuits (FPC) and rigid-flex boards. Products are widely used in 5G communication equipment, AI servers, autonomous driving systems, medical electronic equipment and aerospace fields.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('lab', 'business', '重点实验室科研成果', 'Key Lab Research Achievements', '重点实验室科研成果涵盖先进封装基板材料、高频高速PCB工艺、功率半导体封装及系统集成等方向，多项成果已完成产业化转化并应用于客户产品中。', 'Key lab research achievements cover advanced packaging substrate materials, high-frequency high-speed PCB processes, power semiconductor packaging and system integration. Multiple achievements have been industrialized and applied in customer products.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('global', 'business', '全球产业布局', 'Global Industry Layout', '全球产业布局覆盖中国内地（深圳、东莞、惠州、南通、杭州）、香港及海外市场，形成以华南为核心、辐射华东、布局全球的产业网络。', 'The global industry layout covers mainland China (Shenzhen, Dongguan, Huizhou, Nantong, Hangzhou), Hong Kong and overseas markets, forming an industrial network centered in South China, radiating to East China and globally.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('board', 'about', '董事局', 'Board of Directors', '航天控股董事局由执行董事、非执行董事及独立非执行董事组成，负责制定集团整体战略方向，监督管理层执行业务计划，确保公司遵守高水平的企业管治标准。', 'The CASIL Board of Directors comprises Executive Directors, Non-Executive Directors and Independent Non-Executive Directors. It is responsible for setting the Group''s overall strategic direction, overseeing management in executing business plans, and ensuring the Company adheres to high standards of corporate governance.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('governance', 'about', '企业管治', 'Corporate Governance', '本公司深信良好的企业管治是保障股东权益及提升企业价值的基础。公司已建立完善的企业管治架构，包括审核委员会、薪酬委员会、提名委员会及环境、社会及管治委员会，各委员会均订明职权范围。本公司定期检讨企业管治守则，确保符合香港联合交易所有限公司证券上市规则附录C1《企业管治守则》的要求。', 'The Company firmly believes that good corporate governance is the foundation for protecting shareholders'' rights and enhancing corporate value. The Company has established a comprehensive corporate governance structure, including the Audit Committee, Remuneration Committee, Nomination Committee and ESG Committee, each with clearly defined terms of reference. The Company regularly reviews its corporate governance practices to ensure compliance with the Corporate Governance Code set out in Appendix C1 of the Rules Governing the Listing of Securities on The Stock Exchange of Hong Kong Limited.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('business', 'business', '产业与业务', 'Business', '本公司及各附属公司的主要业务涵盖科技工业及航天服务业务，包括高精密电子组件、核心产品体系、重点实验室科研成果及全球产业布局。', 'The principal businesses of the Company and its subsidiaries cover technology industry and aerospace services, including precision electronic components, core product systems, key laboratory research achievements, and global industrial layout.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('links', 'other', '航天联结', 'Aerospace Links', '航天联结栏目汇集中国航天科技集团及相关企业的链接资源，包括子公司、合作单位及研究机构等。', 'The Aerospace Links section brings together links to CASC and related enterprises, including subsidiaries, partner organizations and research institutions.', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('location', 'other', '地理位置', 'Location', '中国航天国际控股有限公司总部设于香港，在中国内地多个城市（深圳、东莞、惠州、南通、杭州等）设有生产基地及办事处。', 'China Aerospace International Holdings Limited is headquartered in Hong Kong, with production bases and offices in multiple cities across mainland China (Shenzhen, Dongguan, Huizhou, Nantong, Hangzhou, etc.).', 0);
INSERT INTO pages (id, section, title_zh, title_en, content_zh, content_en, sort_order) VALUES ('contact', 'other', '联系我们', 'Contact Us', '如有任何查询，欢迎通过以下渠道与我们联系。航天控股致力于为全球客户、合作伙伴及投资者提供高效、专业的服务。', 'For any inquiries, please contact us through the following channels. CASIL is committed to providing efficient and professional services to global customers, partners and investors.', 0);
...
INSERT INTO board_members (id, name_zh, name_en, title_zh, title_en, bio_zh, bio_en, member_type, sort_order) VALUES (19, '羅振邦先生', 'Mr. Luo Zhenbang', '獨立非執行董事', 'Independent Non-Executive Director', '羅振邦先生，為本公司獨立非執行董事及立信會計師事務所（特殊普通合夥）董事、管理合夥人。羅先生於1991年畢業於蘭州商學院的企業管理專業，自1994年起至今先後主持過多間上市公司的審計工作，曾擔任中國信達資產管理公司及中國長城資產管理公司專家監事、長征火箭股份有限公司、東方鉭業股份有限公司、吳忠儀錶股份有限公司、聖雪絨股份有限公司、中航重機股份有限公司、神州數碼信息服務股份有限公司、新疆金風科技股份有限公司、高偉電子控股有限公司的獨立董事、於深圳證券交易所上市之東北證券股份有限公司（股份代號：000686）內核專家和於香港聯合交易所上市之國瑞健康產業有限公司（股份代號：2329）的獨立非執行董事。現任於香港聯合交易所上市的京投軌道交通科技控股有限公司（股份代號：1522）的獨立非執行董事。羅先生持有中國註冊會計師、證券期貨業特許會計師、中國註冊資產評估師、中國註冊稅務師等專業資格，具有深厚的會計、審計和財務管理經驗，以及對各行業上市公司均有豐富的審計經驗，並廣泛參與企業改組上市、上市公司重組等商務諮詢工作。彼於2004年12月起出任本公司獨立非執行董事。', 'Mr. Luo Zhenbang is an Independent Non-Executive Director of the Company and a director and managing partner of BDO China. He graduated from Lanzhou Commercial College in 1991. He holds professional qualifications as a Chinese CPA and securities and futures chartered accountant. He has served as an Independent Non-Executive Director since December 2004.', 'independent', 3);
INSERT INTO board_members (id, name_zh, name_en, title_zh, title_en, bio_zh, bio_en, member_type, sort_order) VALUES (20, '陳靜茹女士', 'Ms. Chen Jingru', '獨立非執行董事', 'Independent Non-Executive Director', '陳靜茹女士，法學碩士，為本公司獨立非執行董事和北京德恒律師事務所的全球合夥人。陳女士於1985年及1990年獲南開大學頒發法律學士學位及碩士學位。彼於1993年獲中華人民共和國司法部律師資格委員會授予專業律師資格。曾任中央財政金融學院（現稱中央財經大學）保險系綜合教研室副主任、北京保險學會理事、中國海商法學會理事、中央財經大學法律系副主任，以及中國證監會第三屆創業板發審委委員。陳女士於2011年5月至2014年1月擔任於深圳證券交易所上市的中科雲網科技集團股份有限公司（股份代號：002306）的獨立董事、於2014年7月至2022年11月擔任於香港聯合交易所上市的國瑞健康產業有限公司（股份代號：2329）的獨立非執行董事，以及於2019年10月至2022年10月擔任於上海證券交易所上市的中銀國際證券股份有限公司（股份代號：601696）外聘內核委員。陳女士自1993年起任職北京德恒律師事務所，彼在企業及證券方面擁有豐富經驗，於2022年8月起出任本公司獨立非執行董事。', 'Ms. Chen Jingru, LLM, is an Independent Non-Executive Director and a global partner of Beijing DeHeng Law Offices. She obtained her Bachelor''s and Master''s degrees in Law from Nankai University. She has extensive experience in corporate and securities matters and has served as an Independent Non-Executive Director since August 2022.', 'independent', 4);
INSERT INTO board_members (id, name_zh, name_en, title_zh, title_en, bio_zh, bio_en, member_type, sort_order) VALUES (21, '薛蘭女士', 'Ms. Xue Lan', '獨立非執行董事', 'Independent Non-Executive Director', '薛蘭女士，畢業于中國人民大學，先後於1986年及1996年獲取歷史學士及經濟學碩士學位，並于2001年于北京大學光華管理學院修畢EMBA學位。1986年8月至1988年12月，薛女士擔任中華人民共和國外交部檔案館助理館員；1988年12月至1992年12月擔任中華人民共和國駐澳洲悉尼總領館副領。薛女士于1992年12月至1997年8月加入中國證券業協會，擔任國際部主任。1997年8月至2005年12月，彼于華夏證券股份有限公司擔任國際業務部總經理；2005年12月至2006年8月，擔任中信建投證券股份有限公司（其股份于香港聯合交易所（股份代號:6066）及上海證券交易所上市）國際業務部總經理；2006年8月至2014年3月，擔任中銀國際控股有限公司董事總經理及金融產品部聯席主管；2014年3月至2018年3月，擔任華泰金融控股有限公司首席運營官。薛女士為香港證券及期貨事務監察委員會註冊1、2、4、5及9號牌照的負責人員。薛女士于金融業擁有豐富經驗和知識，彼於2024年3月起出任本公司獨立非執行董事。', 'Ms. Xue Lan graduated from Renmin University of China and obtained an EMBA from Peking University''s Guanghua School of Management. She has extensive experience in the financial industry and has served as an Independent Non-Executive Director since March 2024.', 'independent', 5);
...
INSERT INTO links (id, name_zh, name_en, url, sort_order) VALUES (18, '志豪微电子（惠州）有限公司', 'Zhihao Microelectronics (Huizhou) Co., Ltd.', '', 6);
