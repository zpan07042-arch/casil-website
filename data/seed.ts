...
const pages: [string, string, string, string, string, string, number][] = [
  ...
  [
    ...
    "董事局與管理層",
    "Board & Management",
    "航天控股董事局由執行董事、非執行董事及獨立非執行董事組成，負責制定集團整體戰略方向。管理層團隊具備豐富的行業經驗與專業背景，在董事局領導下有效執行業務計劃，確保公司遵守高水平的企業管治標準。",
    "The CASIL Board comprises Executive Directors, Non-Executive Directors and Independent Non-Executive Directors, responsible for setting the Group's overall strategic direction. The management team brings extensive industry experience and professional expertise, effectively executing business plans under the Board's leadership to ensure the Company adheres to high standards of corporate governance.",
    0,
  ],
  [
    "governance",
  ...
  [
    ...
    "產業與業務",
    "Business",
    "本公司及各附屬公司的主要業務涵蓋科技工業及航天服務業務，聚焦先進製造業與航天產業服務業兩大核心板塊。",
    "The principal businesses of the Company and its subsidiaries cover technology industry and aerospace services, focusing on two core segments: advanced manufacturing and aerospace industry services.",
    0,
  ],
  [
    "location",
  ...
  [
    ...
    "聯繫我們",
    "Contact Us",
    "如有任何查詢，歡迎通過以下渠道與我們聯繫。航天控股致力於爲全球客戶、合作伙伴及投資者提供高效、專業的服務。",
